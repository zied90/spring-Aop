...
public class CustomerAspectPointcut {
    ...
    @Pointcut("execution(* com.exampleaop.springAop.service.CustomerAnotherService.findCustomerByLastName(..))")
    ...
    @Pointcut("within(com.exampleaop.springAop.service.CustomerAnotherService)")
