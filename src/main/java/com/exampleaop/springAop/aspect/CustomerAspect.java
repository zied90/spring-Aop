...
public class CustomerAspect {
    ...
    @Before("execution(* com.exampleaop.springAop.service.CustomerService.getCustomerById(..))")
    public void getCustomerByIdAdvice() {
        System.out.println("Execute advice on getCustomerByIdAdvice()");
    }

    @Before("execution(* com.exampleaop.springAop.service.CustomerService.set*(..))")
